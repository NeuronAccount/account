...
// WithJwt adds the jwt to the logout params
func (o *LogoutParams) WithJwt(jwt string) *LogoutParams {
	o.SetJwt(jwt)
	return o
}

// SetJwt adds the jwt to the logout params
func (o *LogoutParams) SetJwt(jwt string) {
	o.Jwt = jwt
}
